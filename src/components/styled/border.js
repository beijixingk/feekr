...
const border = (Comp) => {
  const BorderedComp = styled(Comp) `
    ...
    &::after {
      ...
      left: 0;
      content: '';
      border-${props=>props.dir!==undefined ? (props.dir+'-width') : 'width'}: ${props => props.width || '0'};
      border-${props=>props.dir!==undefined ? props.dir+'-color' : 'color'}: ${props => props.color || '#ccc'};
      border-${props=>props.dir!==undefined ? props.dir+'-style' : 'style'}: ${props => props.style || 'solid'};
